...
os.makedirs('code_carbon_gemma_3_12b_qlora', exist_ok=True)

tracker = None

if is_main:
    log_name = "biogemma_3_12b_qlora_logs"
    ...
    POWER_CSV = './code_carbon_gemma_3_12b_qlora/power_timeseries.csv'
    ...
    tracker = EmissionsTracker(
        project_name = 'bio-gemma-3-12b-qlora',
        output_dir="./code_carbon_gemma_3_12b_qlora/",
        save_to_file=True,
        on_csv_write='append',
...
training_arguments = TrainingArguments(
    ...
    push_to_hub=True,
    hub_token=hf_token,
    hub_model_id="darmasrmz/bio-gemma-3-12b-qlora",
    hub_strategy="end",
)
...
if is_main:
    ...
    energy_summary.to_csv('bio-gemma-3-12b-qlora-energy_summary.csv', index=False)
